...
Namespace AlterEgo
    ...
    Public Class frmChangePW
        ...
        Public Sub New()
            ...
            Me.ScreenWidth1 = Screen.PrimaryScreen.WorkingArea.Width
            Me.ScreenHeight1 = Screen.PrimaryScreen.WorkingArea.Height
        ...
        Private Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Else
                ...
                Me.Hide
                Dim length As Integer = MyProject.Forms.frmAdminTK.AdminTabsControl1.CtrlListProcessing1.BatchArray.Length
                Dim i As Integer = 0
                Do While (i <= length)
                    If (Strings.StrComp(MyProject.Forms.frmAdminTK.AdminTabsControl1.CtrlListProcessing1.BatchArray(i), "", CompareMethod.Binary) = 0) Then
                        Exit Do
                    End If
                    MyProject.Forms.frmAdminTK.AdminTabsControl1.CtrlListProcessing1.ChangePasswords(MyProject.Forms.frmAdminTK.AdminTabsControl1.CtrlListProcessing1.BatchArray(i), Me.txtUsername.Text, Me.txtPass1.Text)
                    i += 1
                Loop
                Interaction.MsgBox("Batch changes completed", MsgBoxStyle.ApplicationModal, Nothing)
                Me.Dispose
            End If
        End Sub
        ...
        Private Sub frmChangePW_Load(ByVal sender As Object, ByVal e As EventArgs)
            Dim epw As frmChangePW = Me
            epw.Top = CInt(Math.Round(CDbl((CDbl((Me.ScreenHeight1 - epw.Height)) / 2))))
            epw.Left = CInt(Math.Round(CDbl((CDbl((Me.ScreenWidth1 - epw.Width)) / 2))))
            epw.Text = ("Change PW - " & modMain.CurrentUser)
            epw = Nothing
        End Sub

        <DebuggerStepThrough> _
        Private Sub InitializeComponent()
            Dim manager As New ComponentResourceManager(GetType(frmChangePW))
        ...
        Friend ScreenHeight1 As Integer
        Friend ScreenWidth1 As Integer
    End Class
End Namespace
